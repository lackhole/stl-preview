...
inline std::uint8_t BOOST_CONSTEXPR endian_reverse_impl( std::uint8_t x ) noexcept
{
    return x;
}

inline std::uint16_t BOOST_ENDIAN_CONSTEXPR endian_reverse_impl( std::uint16_t x ) noexcept
{
...
inline std::uint32_t BOOST_ENDIAN_CONSTEXPR endian_reverse_impl( std::uint32_t x ) noexcept
{
#ifdef BOOST_ENDIAN_NO_INTRINSICS
...
inline std::uint64_t BOOST_ENDIAN_CONSTEXPR endian_reverse_impl( std::uint64_t x ) noexcept
{
#ifdef BOOST_ENDIAN_NO_INTRINSICS
...
inline __uint128_t BOOST_ENDIAN_CONSTEXPR endian_reverse_impl( __uint128_t x ) noexcept
{
