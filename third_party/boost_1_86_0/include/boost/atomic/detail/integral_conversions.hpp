...
BOOST_FORCEINLINE Output zero_extend_impl(Input input, std::true_type) noexcept
{
    ...
    return atomics::detail::bitwise_cast< Output >(static_cast< std::make_unsigned_t< Output > >(
        static_cast< std::make_unsigned_t< Input > >(input)));
}

template< typename Output, typename Input >
BOOST_FORCEINLINE Output zero_extend_impl(Input input, std::false_type) noexcept
{
    return static_cast< Output >(static_cast< std::make_unsigned_t< Input > >(input));
}
...
{
    return atomics::detail::zero_extend_impl< Output >(input, std::integral_constant< bool, std::is_signed< Output >::value >());
}
...
{
    return static_cast< Output >(atomics::detail::bitwise_cast< std::make_signed_t< Input > >(input));
}
