...
struct storage_traits< 2u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = std::alignment_of< boost::uint16_t >::value;
...
struct storage_traits< 4u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = std::alignment_of< boost::uint32_t >::value;
...
struct storage_traits< 8u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = std::alignment_of< boost::uint64_t >::value;
...
struct storage_traits< 16u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = std::alignment_of< boost::uint128_type >::value;
    static BOOST_CONSTEXPR_OR_CONST std::size_t alignment = 16u;
};
...
struct storage_traits< 16u >
{
    typedef buffer_storage< 16u, std::alignment_of< atomics::detail::max_align_t >::value > type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = std::alignment_of< atomics::detail::max_align_t >::value;
    static BOOST_CONSTEXPR_OR_CONST std::size_t alignment = 16u;
};
