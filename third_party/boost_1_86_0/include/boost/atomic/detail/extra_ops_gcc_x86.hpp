...
#define BOOST_ATOMIC_DETAIL_CAS_LOOP(op, original, result)\
    ...
    static BOOST_FORCEINLINE storage_type fetch_negate(storage_type volatile& storage, std::memory_order) noexcept
    {
    ...
    static BOOST_FORCEINLINE storage_type fetch_complement(storage_type volatile& storage, std::memory_order) noexcept
    {
        storage_type original = storage;
        temp_storage_type result;
    ...
    static BOOST_FORCEINLINE storage_type negate(storage_type volatile& storage, std::memory_order) noexcept
    {
        storage_type original = storage;
        temp_storage_type result;
        BOOST_ATOMIC_DETAIL_CAS_LOOP("negb", original, result);
    ...
    static BOOST_FORCEINLINE storage_type bitwise_complement(storage_type volatile& storage, std::memory_order) noexcept
    {
        storage_type original = storage;
        temp_storage_type result;
        BOOST_ATOMIC_DETAIL_CAS_LOOP("notb", original, result);
...
#define BOOST_ATOMIC_DETAIL_CAS_LOOP(op, argument, original, result)\
    ...
    static BOOST_FORCEINLINE storage_type bitwise_and(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        storage_type original = storage;
        temp_storage_type result;
    ...
    static BOOST_FORCEINLINE storage_type bitwise_or(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        storage_type original = storage;
        temp_storage_type result;
    ...
    static BOOST_FORCEINLINE storage_type bitwise_xor(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        storage_type original = storage;
        temp_storage_type result;
...
#undef BOOST_ATOMIC_DETAIL_CAS_LOOP
    ...
    static BOOST_FORCEINLINE void opaque_add(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
    ...
    static BOOST_FORCEINLINE void opaque_sub(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        if (BOOST_ATOMIC_DETAIL_IS_CONSTANT(v) && v == 1)
        {
            __asm__ __volatile__
    ...
    static BOOST_FORCEINLINE void opaque_negate(storage_type volatile& storage, std::memory_order) noexcept
    {
        __asm__ __volatile__
        (
            "lock; negb %[storage]\n\t"
    ...
    static BOOST_FORCEINLINE void opaque_and(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        __asm__ __volatile__
        (
    ...
    static BOOST_FORCEINLINE void opaque_or(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        __asm__ __volatile__
        (
    ...
    static BOOST_FORCEINLINE void opaque_xor(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        __asm__ __volatile__
        (
    ...
    static BOOST_FORCEINLINE void opaque_complement(storage_type volatile& storage, std::memory_order) noexcept
    {
        __asm__ __volatile__
        (
            "lock; notb %[storage]\n\t"
    ...
    static BOOST_FORCEINLINE bool add_and_test(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        bool res;
    ...
    static BOOST_FORCEINLINE bool sub_and_test(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        bool res;
#if defined(BOOST_ATOMIC_DETAIL_ASM_HAS_FLAG_OUTPUTS)
        if (BOOST_ATOMIC_DETAIL_IS_CONSTANT(v) && v == 1)
    ...
    static BOOST_FORCEINLINE bool and_and_test(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        bool res;
#if defined(BOOST_ATOMIC_DETAIL_ASM_HAS_FLAG_OUTPUTS)
        __asm__ __volatile__
    ...
    static BOOST_FORCEINLINE bool or_and_test(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        bool res;
#if defined(BOOST_ATOMIC_DETAIL_ASM_HAS_FLAG_OUTPUTS)
        __asm__ __volatile__
    ...
    static BOOST_FORCEINLINE bool xor_and_test(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        bool res;
#if defined(BOOST_ATOMIC_DETAIL_ASM_HAS_FLAG_OUTPUTS)
        __asm__ __volatile__
...
#undef BOOST_ATOMIC_DETAIL_CAS_LOOP
    ...
    static BOOST_FORCEINLINE bool bit_test_and_complement(storage_type volatile& storage, unsigned int bit_number, std::memory_order) noexcept
    {
        bool res;
#if defined(BOOST_ATOMIC_DETAIL_ASM_HAS_FLAG_OUTPUTS)
        __asm__ __volatile__
