...
BOOST_ATOMIC_DECL void unlock(void* ls) noexcept;

BOOST_ATOMIC_DECL void* allocate_wait_state(void* ls, const volatile void* addr) noexcept;
BOOST_ATOMIC_DECL void free_wait_state(void* ls, void* ws) noexcept;
BOOST_ATOMIC_DECL void wait(void* ls, void* ws) noexcept;
BOOST_ATOMIC_DECL void notify_one(void* ls, const volatile void* addr) noexcept;
BOOST_ATOMIC_DECL void notify_all(void* ls, const volatile void* addr) noexcept;
