...
struct core_operations_gcc_sync_base
{
    ...
    {
        if ((static_cast< unsigned int >(order) & (static_cast< unsigned int >(std::memory_order_acquire) | static_cast< unsigned int >(std::memory_order_consume))) != 0u)
            __sync_synchronize();
    }
};
    ...
    public core_operations_gcc_sync_base
{
    ...
    typedef std::integral_constant< bool, storage_size <= sizeof(void*) > plain_stores_loads_are_atomic;
    ...
    static BOOST_FORCEINLINE void store(storage_type volatile& storage, storage_type v, std::memory_order order, std::true_type) noexcept
    {
    ...
    static BOOST_FORCEINLINE void store(storage_type volatile& storage, storage_type v, std::memory_order order, std::false_type) noexcept
    {
    ...
    static BOOST_FORCEINLINE storage_type load(storage_type const volatile& storage, std::memory_order order, std::true_type) noexcept
    {
    ...
    static BOOST_FORCEINLINE storage_type load(storage_type const volatile& storage, std::memory_order, std::false_type) noexcept
    {
    ...
    static BOOST_FORCEINLINE storage_type fetch_sub(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
