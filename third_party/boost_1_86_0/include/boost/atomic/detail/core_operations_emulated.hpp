    ...
    public core_operations_emulated_base< Size, Alignment >
{
    ...
    static void store(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
    ...
    static storage_type load(storage_type const volatile& storage, std::memory_order) noexcept
    {
        static_assert(!is_interprocess, "Boost.Atomic: operation invoked on a non-lock-free inter-process atomic object");
        scoped_lock lock(&storage);
    ...
    static storage_type fetch_add(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        static_assert(!is_interprocess, "Boost.Atomic: operation invoked on a non-lock-free inter-process atomic object");
    ...
    static storage_type fetch_sub(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        static_assert(!is_interprocess, "Boost.Atomic: operation invoked on a non-lock-free inter-process atomic object");
        storage_type& s = const_cast< storage_type& >(storage);
        scoped_lock lock(&storage);
    ...
    static storage_type exchange(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        static_assert(!is_interprocess, "Boost.Atomic: operation invoked on a non-lock-free inter-process atomic object");
        storage_type& s = const_cast< storage_type& >(storage);
        scoped_lock lock(&storage);
    ...
    static storage_type fetch_and(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        static_assert(!is_interprocess, "Boost.Atomic: operation invoked on a non-lock-free inter-process atomic object");
        storage_type& s = const_cast< storage_type& >(storage);
        scoped_lock lock(&storage);
    ...
    static storage_type fetch_or(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        static_assert(!is_interprocess, "Boost.Atomic: operation invoked on a non-lock-free inter-process atomic object");
        storage_type& s = const_cast< storage_type& >(storage);
        scoped_lock lock(&storage);
    ...
    static storage_type fetch_xor(storage_type volatile& storage, storage_type v, std::memory_order) noexcept
    {
        static_assert(!is_interprocess, "Boost.Atomic: operation invoked on a non-lock-free inter-process atomic object");
        storage_type& s = const_cast< storage_type& >(storage);
        scoped_lock lock(&storage);
