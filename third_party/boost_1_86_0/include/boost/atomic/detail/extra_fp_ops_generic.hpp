    ...
    public Base
{
    ...
    static BOOST_FORCEINLINE value_type fetch_negate(storage_type volatile& storage, std::memory_order order) noexcept
    {
        ...
        while (!base_type::compare_exchange_weak(storage, old_storage, new_storage, order, std::memory_order_relaxed));
        return old_val;
    }

    static BOOST_FORCEINLINE value_type negate(storage_type volatile& storage, std::memory_order order) noexcept
    {
        storage_type old_storage, new_storage;
        value_type old_val, new_val;
        atomics::detail::non_atomic_load(storage, old_storage);
    ...
    public extra_fp_negate_generic< Base, Value, Size >
{
    ...
    static BOOST_FORCEINLINE value_type add(storage_type volatile& storage, value_type v, std::memory_order order) noexcept
    {
        storage_type old_storage, new_storage;
        value_type old_val, new_val;
        atomics::detail::non_atomic_load(storage, old_storage);
    ...
    static BOOST_FORCEINLINE value_type sub(storage_type volatile& storage, value_type v, std::memory_order order) noexcept
    {
        storage_type old_storage, new_storage;
        value_type old_val, new_val;
        atomics::detail::non_atomic_load(storage, old_storage);
    ...
    static BOOST_FORCEINLINE void opaque_add(storage_type volatile& storage, value_type v, std::memory_order order) noexcept
    {
        base_type::fetch_add(storage, v, order);
    }

    static BOOST_FORCEINLINE void opaque_sub(storage_type volatile& storage, value_type v, std::memory_order order) noexcept
    {
