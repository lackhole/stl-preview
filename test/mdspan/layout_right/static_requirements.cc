...
void test_mapping_requirements(std::index_sequence<Idxs...>) {
  ...
  EXPECT_EQ_TYPE(typename M::layout_type, preview::layout_right);
...
void test_layout_mapping_right() {
  test_layout_mapping_requirements<preview::layout_right, E>();
}

TEST(MdspanLayoutRight, VERSIONED(static_requirements)) {
