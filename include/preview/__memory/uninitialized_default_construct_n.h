...
//
// Algorithm 26.11.3 uninitialized_default_construct (uninitialized.construct.default)
// https://eel.is/c++draft/algorithms#uninitialized.construct.default

#ifndef PREVIEW_MEMORY_UNINITIALIZED_DEFAULT_CONSTRUCT_N_H_
#define PREVIEW_MEMORY_UNINITIALIZED_DEFAULT_CONSTRUCT_N_H_
...
struct uninitialized_default_construct_n_niebloid {
  ...
  constexpr I operator()(I first, iter_difference_t<I> n) const {
    return preview::uninitialized_default_construct(counted_iterator<I>{first, n}, default_sentinel).base();
  }
};

} // namespace detail

PREVIEW_INLINE_VARIABLE constexpr detail::uninitialized_default_construct_n_niebloid uninitialized_default_construct_n{};

} // namespace ranges
} // namespace preview 

#endif // PREVIEW_MEMORY_UNINITIALIZED_DEFAULT_CONSTRUCT_N_H_
