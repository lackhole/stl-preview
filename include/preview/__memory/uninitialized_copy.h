...
#ifndef PREVIEW_MEMORY_UNINITIALIZED_COPY_H_
#define PREVIEW_MEMORY_UNINITIALIZED_COPY_H_
...
constexpr void uninitialized_copy(InputIterator first, InputIterator last, NoThrowForwardIterator result)
...
struct uninitialized_copy_niebloid {
  ...
  >, int> = 0>
  constexpr uninitialized_copy_result<I, O> operator()(I ifirst, S ilast, O ofirst, S2 olast) const {
#if !PREVIEW_CONFORM_CXX20_STANDARD
    using namespace preview::rel_ops;
#endif
...
PREVIEW_INLINE_VARIABLE constexpr detail::uninitialized_copy_niebloid uninitialized_copy{};

} // namespace ranges
} // namespace preview 

#endif // PREVIEW_MEMORY_UNINITIALIZED_COPY_H_
