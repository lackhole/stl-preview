...
#ifndef PREVIEW_ALGORITHM_RANGES_ANY_OF_H_
#define PREVIEW_ALGORITHM_RANGES_ANY_OF_H_
...
PREVIEW_INLINE_VARIABLE constexpr detail::any_of_niebloid any_of{};

} // namespace ranges
} // namespace preview

#endif // PREVIEW_ALGORITHM_RANGES_ANY_OF_H_
