...
#ifndef PREVIEW_ALGORITHM_RANGES_FIND_IF_NOT_H_
#define PREVIEW_ALGORITHM_RANGES_FIND_IF_NOT_H_
...
PREVIEW_INLINE_VARIABLE constexpr detail::find_if_not_niebloid find_if_not{};

} // namespace ranges
} // namespace preview

#endif // PREVIEW_ALGORITHM_RANGES_FIND_IF_NOT_H_
