...
#ifndef PREVIEW_ALGORITHM_RANGES_POP_HEAP_H_
#define PREVIEW_ALGORITHM_RANGES_POP_HEAP_H_
...
PREVIEW_INLINE_VARIABLE constexpr detail::pop_heap_niebloid pop_heap{};

} // namespace ranges
} // namespace preview

#endif // PREVIEW_ALGORITHM_RANGES_POP_HEAP_H_
