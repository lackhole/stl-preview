...
#ifndef PREVIEW_ALGORITHM_RANGES_OUT_VALUE_RESULT_H_
#define PREVIEW_ALGORITHM_RANGES_OUT_VALUE_RESULT_H_
...
struct out_value_result {
  PREVIEW_NO_UNIQUE_ADDRESS I out;
...
#endif // PREVIEW_ALGORITHM_RANGES_OUT_VALUE_RESULT_H_
