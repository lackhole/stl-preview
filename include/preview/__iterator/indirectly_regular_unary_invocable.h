...
#ifndef PREVIEW_ITERATOR_INDIRECT_REGULAR_UNARY_INVOCABLE_H_
#define PREVIEW_ITERATOR_INDIRECT_REGULAR_UNARY_INVOCABLE_H_
...
#endif // PREVIEW_ITERATOR_INDIRECT_REGULAR_UNARY_INVOCABLE_H_
