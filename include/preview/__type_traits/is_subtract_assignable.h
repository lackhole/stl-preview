...
#ifndef PREVIEW_TYPE_TRAITS_IS_SUBTRACT_ASSIGNABLE_H_
#define PREVIEW_TYPE_TRAITS_IS_SUBTRACT_ASSIGNABLE_H_
...
struct is_subtract_assignable<T, U, Constraint, CallArgs, Proj, void_t<decltype(std::declval<T>() -= std::declval<U>())>>
